...
if("TRUE" STREQUAL "TRUE")
  set(master_core_SOURCE_PREFIX /home/soroush/training_repo/src/master_core)
  set(master_core_DEVEL_PREFIX /home/soroush/training_repo/devel)
  ...
  set(master_core_INSTALL_PREFIX /home/soroush/training_repo/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'master_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'master_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soroush/training_repo/src/master_core/${idir}'.  ${_report}")
    endif()
